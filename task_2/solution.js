...
function calcDiscount(sum, min, discount) {
    ...
    let discountSum = productsSum >= discountMinSum ? discountPart * productsSum / 100 : 0; //тернарный оператор
...
function calcInvoice({sum, discountMinSum, discountPart, shippingFreeMinSum, shippingPrice}) {
    ...
    Boolean (freeShipping)// запишите без использования if или любых других условий:
